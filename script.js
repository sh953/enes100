...
'<li><a href="#" id="fontDefault">Default</a></li>' +
'<li><a href="#" id="fontLarge">Large</a></li>' +
'<li><a href="#" id="fontMedium">Medium</a></li>' +
'<li><a href="#" id="fontMicro">Micro</a></li>' +
'<li><a href="#" id="fontSmall">Small</a></li>' +
'</ul>' +
'</div>' +
